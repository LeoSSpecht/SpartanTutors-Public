...
struct EditTutorInfoView: View {
    @Binding var show_edit_view: Bool
    @StateObject var viewModel = EditInfoTutorViewModel()
...
//            Spacer()
            ...
            VStack{
                ...
                TextBox(variable: $viewModel.venmo, text: "Venmo username")
                TextBox(variable: $viewModel.zoom_link, text: "Zoom meeting ID")
                TextBox(variable: $viewModel.zoom_password, text: "Zoom password")
                EditClassSelectionView(allClassesViewModel: viewModel)
                    .layoutPriority(2)
